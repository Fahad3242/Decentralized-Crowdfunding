...
function testPriceFeedVersionIsAccurate() public view {
    ...
    if (block.chainid == 1) {
        ...
        // Default for Anvil or other forks
        expectedVersion = 4;
    }

    assertEq(version, expectedVersion, "Price feed version mismatch!");
}
...
function testFundUpdatesFundedDataStructure() public {
    ...
    assertEq(amountFunded, SEND_VALUE, "Amount funded is incorrect!");
}
